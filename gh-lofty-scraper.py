...
# Photo URL pattern: Lofty CDN photos look like
#   https://cdn.lofty.com/image/fs/web/.../w640_original_*.webp
# We accept anything from cdn.lofty.com to be flexible if they change naming.
LOFTY_CDN_HOST = 'cdn.lofty.com'
...
def extract_photo_url(html, expected_name):
    ...
    # Defensive: require the URL be from Lofty's CDN. We don't want to grab
    # decorative placeholder images, social icons, etc.
    if LOFTY_CDN_HOST not in src:
        return None, f'non_lofty_image:{src[:50]}'
